...
const PosCart = ({ backToMenu }: Props) => {
    return (
        <div className="h-screen flex flex-col pt-4">
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white p-4 flex flex-col gap-4 shadow-md ">
                ...
                <button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-3xl transition-all duration-300 flex items-center justify-center gap-2">
                    Checkout
                </button>
            </div>
        </div>
